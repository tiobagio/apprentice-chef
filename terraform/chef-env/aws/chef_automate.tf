...
resource "aws_instance" "chef_automate" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo chef-server-ctl user-create anthony Anthony Rees anthony@chef.io '1234chefabcd' --filename $HOME/anthony.pem",
      "sudo echo xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Client PEM xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
      "sudo cat $HOME/anthony.pem",
      "sudo chef-server-ctl org-create reesyorg 'Reesy Inc.' --association_user anthony --filename $HOME/reesyorg-validator.pem",
      "sudo echo xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Validator PEM xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx",
