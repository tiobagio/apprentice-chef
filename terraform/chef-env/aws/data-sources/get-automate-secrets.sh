...
scp -i ${ssh_key} ${ssh_user}@${a2_ip}:/home/${ssh_user}/anthony.pem $HOME/anthony-${a2_ip}.pem
scp -i ${ssh_key} ${ssh_user}@${a2_ip}:/home/${ssh_user}/reesyorg-validator.pem $HOME/reesyorg-validator-${a2_ip}.pem
